...
const NAV = [
  {group:'Command Center', items:[
    ...
    {id:'reports', label:'Analytics & Reporting', icon:'reports'},
    {id:'analyticsops', label:'Analytics Builder', icon:'reports'},
    {id:'aiinsights', label:'AI Insights', icon:'ai'},
  ]},
  {group:'Customers & Contracts', items:[
    {id:'accounts', label:'Accounts', icon:'accounts'},
    {id:'customerops', label:'Customer Operations', icon:'accounts'},
    {id:'subscriptions', label:'Subscriptions', icon:'subs'},
    {id:'subscriptionops', label:'Subscription Lifecycle', icon:'subs'},
    {id:'catalog', label:'Product Catalog', icon:'catalog'},
    {id:'pricebooks', label:'Price Books & Packaging', icon:'catalog'},
    {id:'calculator', label:'Pricing Calculator', icon:'calc'},
    {id:'quotes', label:'Quotes & Contracts', icon:'quotes', badge:'4', muted:true},
    {id:'contractops', label:'Contract Operations', icon:'quotes'},
    {id:'cpqdesk', label:'CPQ Deal Desk', icon:'calc'},
  ]},
  {group:'Billing Operations', items:[
    {id:'billingruns', label:'Billing Runs', icon:'invoices', badge:'4'},
    {id:'billingpolicies', label:'Billing Policies', icon:'settings'},
    {id:'usage', label:'Usage & Metering', icon:'usage'},
    {id:'usageops', label:'Usage Metering Operations', icon:'usage'},
    {id:'invoices', label:'Invoices', icon:'invoices'},
    {id:'invoiceops', label:'Invoice Operations', icon:'invoices'},
    {id:'credits', label:'Credits & Refunds', icon:'credits'},
  ]},
  {group:'Payments & Receivables', items:[
    {id:'payments', label:'Payments', icon:'payments'},
    {id:'paymentops', label:'Payment Operations', icon:'payments'},
    {id:'ar', label:'A/R & Cash Application', icon:'ar'},
    {id:'dunning', label:'Dunning & Collections', icon:'dunning', badge:'7'},
    {id:'statements', label:'Customer Statements', icon:'ledger'},
  ]},
  {group:'Revenue Accounting', items:[
    {id:'revrec', label:'Revenue Recognition', icon:'revrec'},
    {id:'revaccounting', label:'Revenue Accounting Workbench', icon:'revrec'},
  ...
  {group:'Tax & Compliance', items:[
    ...
    {id:'taxops', label:'Tax Operations', icon:'tax'},
    {id:'controls', label:'Controls & Audit', icon:'shield'},
    {id:'glops', label:'General Ledger Controls', icon:'ledger'},
  ...
  {group:'Organization', items:[
    ...
    {id:'dataops', label:'Data Operations', icon:'migration'},
  ]},
  {group:'Platform', items:[
    {id:'portal',      label:'Customer Portal',       icon:'portal'},
    {id:'developers',  label:'Developers & API',      icon:'api'},
    {id:'developerconsole', label:'Developer Console', icon:'api'},
    {id:'integrations',label:'Integrations',          icon:'plug'},
    {id:'integrationops', label:'Integration Operations', icon:'plug'},
